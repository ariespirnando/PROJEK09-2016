...
<ul class="breadcrumb">
        <li>
            <a href="#">Master / Data Anggota Polsek</a>
        </li>
    </ul>
</div>
        ...
        <div class="box-inner">
            <div class="box-header well">
                ...
                <div class ="text-right">
                    <a href="Anggota_Polsek_Tambah.php" data-toggle="tooltip" class="btn btn-primary btn-sm">Tambah Data</a>
                </div>
            </div>
            ...
            ?>
                        <tr>
                            ...
                            <td class="text-center" style="vertical-align:middle;">
                                <a href="Anggota_Polsek_Ubah.php?id=<?php echo $row['NRP'] ?>" class="btn btn-warning btn-sm"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a>
                                <a href="Anggota_Polsek_Hapus.php?id=<?php echo $row['NRP'] ?>" onclick="return confirm('Yakin ingin menghapus data')" class="btn btn-danger btn-sm"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a>
                            </td>
                        </tr>
            <?php
            }
