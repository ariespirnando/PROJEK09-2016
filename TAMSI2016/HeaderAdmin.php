            ...
            <div class="sidebar-nav">
                <div class="nav-canvas">
                    ...
                    <ul class="nav nav-pills nav-stacked main-menu">
                        ...
                        <li><a class="ajax-link" href="Anggota_PolsekAdmin.php"><i class="glyphicon glyphicon-home"></i><span> Data Anggota Polsek</span></a>
                        <li><a class="ajax-link" href="Setting.php"><i class="glyphicon glyphicon-cog"></i><span> Pengaturan Password</span></a>
